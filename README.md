...
For the most part, you don't need to specifically reference AutoMD, you can just reference the Desmond package. Of course, take care to properly describe the simulation conditions you are using, such as temperature, buffer, and force field. We first used AutoMD in this work below, and if you would like to cite AutoMD, please cite the paper below.   
