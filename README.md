...
```
AutoTRJ -i "*-md" -J PPI -M "APCluster_5+PPIContact+FEL" -C "not sovent" -L "res.ptype UNK"
```

__Options:__  

During runtime, it is possible to specify a task name, which will be used as a prefix for the files generated by AutoTRJ.  
